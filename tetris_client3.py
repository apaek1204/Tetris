...
def run_game(PacketConnectionObject):
    ...
    OPP_lines = 0
    OPP_alive = True
    game_win = PacketConnectionObject.game_state.check_win_condition(OPP_score, OPP_alive)
    draw_screen(surface, PacketConnectionObject.game_state,OPP_score, OPP_level,OPP_lines)
    downclock+=1
